...
//
// NOTES:
// ImageClassificationProvider is a (WIP) refactor of ImagePredictor from the sample
//
import UIKit
import ImageIO
...
///
/// The ImageClassificationProvider (formerly ImagePredictor) creates and reuses an instance of a Core ML image classifier inside a ``VNCoreMLRequest``.
...
class ImageClassificationProvider {
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let imageClassificationRequest = VNCoreMLRequest(model: ImageClassificationProvider.imageClassifier,
